...
exports.apiIndex = function(req, res) {
    var vm = {                          // vm = View Model
        title: 'Rakendus',
        api: [
            { name: 'Kasutajad', url: '/api/users?pagesize=20&page=2' },         
            { name: 'Kasutaja ID kaudu', url: '/api/users/121' },         
            { name: 'Kasutaja kasutajanime kaudu', url: '/api/users/bgellettrr' },  
            { name: 'Profiil', url: '/api/profile/bgellettrr' },
            { name: 'Post', url: '/api/posts/19' },
            { name: 'Statistika', url: '/api/stats' },
            { name: 'TOP 10 meeldivaimad kasutajad', url: '/api/stats/top10/likedusers' },
            { name: 'Kasutajate registreerimised', url: '/api/stats/registrations' },
            { name: 'Sooline jaotuvus', url: '/api/stats/genderdivision' }
        ]
...
exports.top10LikedUsers = function(req, res) {
    var procedureName = 'GetTop10LikedUsers';
    var key = "mi.top10likedusers"; // Unique cache key
